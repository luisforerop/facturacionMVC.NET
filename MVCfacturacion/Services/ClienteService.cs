...
namespace MVCfacturacion.Services
{
    public class ClienteService
    {
        ...
        {
            return _clientes.Find(c => c.empresa == nombre | c.ciudad == nombre).ToList(); //Configuramos el controlador para que obtenga el valor por la URL
        }

        public List<Cliente> Get()
        {
            return _clientes.Find(c => true).ToList(); 
            //Configuramos el controlador para que obtenga el valor por la URL
        }
